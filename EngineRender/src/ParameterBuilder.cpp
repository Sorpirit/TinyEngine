...
{
    ParameterBuilder::ParameterBuilder(const Shaders::ShaderProgram* program) : _program(program)
    {
        _program->Attach();
    }
    ...
    {
        int parameterLocation = glGetUniformLocation(_program->ID, name.c_str());
    ...
    void ParameterBuilder::AddTexture(string name, const Texture& texture)
    {
